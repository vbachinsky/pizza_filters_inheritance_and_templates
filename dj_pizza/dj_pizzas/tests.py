...
from .models import Topping, Order, Dough, Pizza, InstancePizza, Snacks
...
class MyTestClass(TestCase):
    ...
    def setUpTestData(cls):
        ...
        Snacks.objects.create(description='crisps', price=3)
        Snacks.objects.create(description='Crackers', price=2)
...
# test shipping
    ...
    def test_set_shipping(self):
        ...
        response = self.client.post('/set_shipping/', {'first_name':'Chilapuk','last_name':'Batmanovich','email':'example@example.ru', 'phone':'6666666', 'street_adress':'Garlem', 'town_adress':'Babruisk'})
        self.assertEqual(response.status_code, 302)
