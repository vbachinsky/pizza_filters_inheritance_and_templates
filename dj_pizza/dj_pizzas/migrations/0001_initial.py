    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordered_toppings', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='dj_pizzas.OrderedToppings')),
            ],
        ),
        migrations.CreateModel(
            name='Snacks',
        ...
        migrations.CreateModel(
            name='InstancePizza',
            fields=[
                ('pizza_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='dj_pizzas.Pizza')),
                ('price', models.DecimalField(decimal_places=2, max_digits=3)),
                ('pizza', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pizza_templates', to='dj_pizzas.Pizza')),
            ],
            bases=('dj_pizzas.pizza',),
        ),
        migrations.CreateModel(
            name='OrderPayment',
            fields=[
        ...
        migrations.AddField(
            model_name='order',
            name='order',
            field=models.ManyToManyField(to='dj_pizzas.InstancePizza'),
        ),
    ]
